...
require_once plugin_dir_path( dirname( __FILE__ ) ) . '../merchsys/includes/Merchsys_Settings.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/MerchsysStore_Settings.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . '../merchsys/includes/Merchsys_I18n.php';
require_once plugin_dir_path( dirname( __FILE__ ) ) . '../merchsys/includes/Merchsys_Loader.php';
