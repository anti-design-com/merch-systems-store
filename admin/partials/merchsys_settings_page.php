...
<div class="wrap">
	...
	?>
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e('Show carousel in shop main page?', 'merchsys-store'); ?>:</th>
				<td>
			...
			<hr/>
			<tr valign="top">
				<th scope="row"><?php _e('Add categories to page menu as submenu?', 'merchsys-store'); ?>:</th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Show login/logout to navigation?', 'merchsys-store'); ?>:</th>
				<td>
			...
			<!--<tr valign="top">
				<th scope="row"><?php _e('Navigation to add the login/logout and basket items to', 'merchsys-store'); ?>:</th>
				<td><select name="merchsys_navigationname">
				<option><?php _e('Please select a menu', 'merchsys-store'); ?></option>
				<?php
				if ($menus != null) {
			...
			<tr valign="top">
				<th scope="row"><?php _e('Menu item wrapper for added items (%l for the link, %c for the item css class and %t for the text)', 'merchsys-store'); ?>:</th>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Menu item wrapper for the basket (%a for the amount of basket items, %l for the link, %c for the item css class and %t for the text)', 'merchsys-store'); ?>:</th>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Maximum amount of basket items per product (default is 10)', 'merchsys-store'); ?>:</th>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Go to basket after adding an item?', 'merchsys-store'); ?>:</th>
				<td>
	...
	<h3><?php _e("Set-up", 'merchsys-store'); ?></h3>
	...
	<p><?php _e('If you use visual composer in your theme you can add the MerchSys Shop shortcode from the shortcodes list (search for MerchSys)', 'merchsys-store'); ?></p>
	<h2><?php _e('Important!', 'merchsys-store'); ?></h2>
	<p><?php _e('After activating the plugin and the initial set-up please save the permalinks in the Wp settings page in order for the shop to work.', 'merchsys-store'); ?></p>
</div>