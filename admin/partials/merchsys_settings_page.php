...
?>
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e('Show carousel in shop main page?', 'merch-systems-store');?>:</th>
				<td>
			...
			<hr/>
			<tr valign="top">
				<th scope="row"><?php _e('Add categories to page menu as submenu?', 'merch-systems-store');?>:</th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Show login/logout to navigation?', 'merch-systems-store');?>:</th>
				<td>
			...
			<!--<tr valign="top">
				<th scope="row"><?php _e('Navigation to add the login/logout and basket items to', 'merch-systems-store');?>:</th>
				<td><select name="merchsys_navigationname">
				<option><?php _e('Please select a menu', 'merch-systems-store');?></option>
				<?php
if ($menus != null) {
...
?>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Menu item wrapper for added items (%l for the link, %c for the item css class and %t for the text)', 'merch-systems-store');?>:</th>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Menu item wrapper for the basket (%a for the amount of basket items, %l for the link, %c for the item css class and %t for the text)', 'merch-systems-store');?>:</th>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Maximum amount of basket items per product (default is 10)', 'merch-systems-store');?>:</th>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Go to basket after adding an item?', 'merch-systems-store');?>:</th>
				<td>
	...
	<h3><?php _e("Set-up", 'merch-systems-store');?></h3>
	...
	<p><?php _e('If you use visual composer in your theme you can add the MerchSys Shop shortcode from the shortcodes list (search for MerchSys)', 'merch-systems-store');?></p>
	<h2><?php _e('Important!', 'merch-systems-store');?></h2>
	<p><?php _e('After activating the plugin and the initial set-up please save the permalinks in the Wp settings page in order for the shop to work.', 'merch-systems-store');?></p>
</div>